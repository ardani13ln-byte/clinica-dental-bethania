    ...
    <div className="relative flex-1 overflow-auto bg-card">
      <div className="flex min-w-fit">
        ...
        <div className="sticky left-0 z-20 w-16 shrink-0 bg-card">
          <div className="sticky top-0 z-10 border-b border-border/50 bg-card" style={{ height: HEADER_H }} />
        ...
        {operatories.map((op, idx) => {
          ...
          return (
            ...
            >
              {/* Header */}
              <div
                className="sticky top-0 z-10 flex flex-col justify-center border-b border-border/50 bg-card px-4"
        ...
        <div className="flex min-w-0 flex-1 flex-col border-l border-border/50 bg-card">
          <div className="sticky top-0 z-10 border-b border-border/50 bg-card" style={{ height: HEADER_H }} />
          <div className="relative" style={{ height: totalHeight }}>
            {hourLabels.map(({ hour, topPx }) => (
              <div
